...
public class UrlUpdateTest extends UrlPropertyForTest {
    ...
    public void Url_Update_테스트() throws InterruptedException {
        Url testUrl = new Url("http://www.test.com", "testKey");
        ...
        urlUpdateRequestDto.setOriginUrl("http://www.test.com");
        ...
        readByOriginUrlRequestDto.setOriginUrl("http://www.test.com");
